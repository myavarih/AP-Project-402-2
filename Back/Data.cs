        ...
        public static List<Restaurant>  restaurants { get; set; } = new List<Restaurant>
{
    ...
    new Restaurant("restaurant_2", "password123", "Gourmet Grill", "Los Angeles", "456 Elm St", true, false, 3.8,
        new List<Food>
        {
            new Food("Steak at Gourmet Grill", "Beef, Potatoes, Vegetables", "", 18.99, "Steakhouse", 4.2, "restaurant_2", 30),
            new Food("Salad at Gourmet Grill", "Lettuce, Cucumber, Tomato", "", 9.99, "Healthy", 3.8, "restaurant_2", 35)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_3", "password123", "Spice Fusion", "Chicago", "789 Oak Ave", false, true, 4.5,
        new List<Food>
        {
            new Food("Sushi at Spice Fusion", "Rice, Seaweed, Fish", "", 22.50, "Japanese", 4.7, "restaurant_3", 25),
            new Food("Tacos at Spice Fusion", "Tortilla, Beef, Cheese", "", 11.99, "Mexican", 4.3, "restaurant_3", 40)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_4", "password123", "Bella Italia", "Miami", "101 Pine Blvd", true, true, 4.0,
        new List<Food>
        {
            new Food("Pasta at Bella Italia", "Tomato Sauce, Pasta, Cheese", "", 16.99, "Italian", 4.0, "restaurant_4", 20),
            new Food("Soup at Bella Italia", "Chicken Broth, Vegetables", "", 8.50, "Soup", 3.5, "restaurant_4", 15)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_5", "password123", "Sushi Sensation", "San Francisco", "202 Cedar Ln", false, true, 4.3,
        new List<Food>
        {
            new Food("Sashimi at Sushi Sensation", "Fresh Fish", "", 25.00, "Japanese", 4.5, "restaurant_5", 28),
            new Food("Tempura at Sushi Sensation", "Shrimp, Vegetables", "", 19.99, "Japanese", 4.1, "restaurant_5", 32)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_6", "password123", "BBQ Delight", "Houston", "303 Maple Rd", true, false, 4.1,
        new List<Food>
        {
            new Food("BBQ Ribs at BBQ Delight", "Pork Ribs, BBQ Sauce", "", 17.99, "BBQ", 4.2, "restaurant_6", 22),
            new Food("Grilled Chicken at BBQ Delight", "Chicken, Seasoning", "", 14.50, "BBQ", 4.0, "restaurant_6", 25)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_7", "password123", "Veggie Haven", "Seattle", "404 Walnut Ave", true, true, 4.4,
        new List<Food>
        {
            new Food("Vegetarian Pizza at Veggie Haven", "Tomato Sauce, Cheese, Mixed Vegetables", "", 14.99, "Vegetarian", 4.3, "restaurant_7", 18),
            new Food("Salad Bowl at Veggie Haven", "Lettuce, Cucumber, Bell Peppers", "", 10.99, "Healthy", 4.5, "restaurant_7", 20)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_8", "password123", "Seafood Paradise", "Boston", "505 Birch St", false, true, 4.6,
        new List<Food>
        {
            new Food("Lobster Roll at Seafood Paradise", "Lobster Meat, Buttered Roll", "", 28.50, "Seafood", 4.7, "restaurant_8", 15),
            new Food("Fish and Chips at Seafood Paradise", "Fried Fish, Potato Wedges", "", 19.75, "Seafood", 4.5, "restaurant_8", 12)
        },
        new List<Order>(),
