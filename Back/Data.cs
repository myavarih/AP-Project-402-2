        ...
        public static List<Restaurant>  restaurants { get; set; } = new List<Restaurant>
{
    new Restaurant("restaurant_1", "password123", "Tasty Bites", "New York", "123 Main St", true, true, 4.2,
        new List<Food>
        {
            new Food("Cheeseburger at Tasty Bites", "Beef, Cheese, Lettuce", new BitmapImage(), 12.50, "Fast Food", "restaurant_1", 50),
            new Food("Pizza at Tasty Bites", "Tomato Sauce, Cheese, Pepperoni", new BitmapImage(), 15.75, "Italian", "restaurant_1", 45)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_2", "password123", "Gourmet Grill", "Los Angeles", "456 Elm St", true, false, 3.8,
        new List<Food>
        {
            new Food("Steak at Gourmet Grill", "Beef, Potatoes, Vegetables", new BitmapImage(), 18.99, "Steakhouse", "restaurant_2", 30),
            new Food("Salad at Gourmet Grill", "Lettuce, Cucumber, Tomato", new BitmapImage(), 9.99, "Healthy", "restaurant_2", 35)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_3", "password123", "Spice Fusion", "Chicago", "789 Oak Ave", false, true, 4.5,
        new List<Food>
        {
            new Food("Sushi at Spice Fusion", "Rice, Seaweed, Fish", new BitmapImage(), 22.50, "Japanese", "restaurant_3", 25),
            new Food("Tacos at Spice Fusion", "Tortilla, Beef, Cheese", new BitmapImage(), 11.99, "Mexican", "restaurant_3", 40)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_4", "password123", "Bella Italia", "Miami", "101 Pine Blvd", true, true, 4.0,
        new List<Food>
        {
            new Food("Pasta at Bella Italia", "Tomato Sauce, Pasta, Cheese", new BitmapImage(), 16.99, "Italian", "restaurant_4", 20),
            new Food("Soup at Bella Italia", "Chicken Broth, Vegetables", new BitmapImage(), 8.50, "Soup", "restaurant_4", 15)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_5", "password123", "Sushi Sensation", "San Francisco", "202 Cedar Ln", false, true, 4.3,
        new List<Food>
        {
            new Food("Sashimi at Sushi Sensation", "Fresh Fish", new BitmapImage(), 25.00, "Japanese", "restaurant_5", 28),
            new Food("Tempura at Sushi Sensation", "Shrimp, Vegetables", new BitmapImage(), 19.99, "Japanese", "restaurant_5", 32)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_6", "password123", "BBQ Delight", "Houston", "303 Maple Rd", true, false, 4.1,
        new List<Food>
        {
            new Food("BBQ Ribs at BBQ Delight", "Pork Ribs, BBQ Sauce", new BitmapImage(), 17.99, "BBQ", "restaurant_6", 22),
            new Food("Grilled Chicken at BBQ Delight", "Chicken, Seasoning", new BitmapImage(), 14.50, "BBQ", "restaurant_6", 25)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_7", "password123", "Veggie Haven", "Seattle", "404 Walnut Ave", true, true, 4.4,
        new List<Food>
        {
            new Food("Vegetarian Pizza at Veggie Haven", "Tomato Sauce, Cheese, Mixed Vegetables", new BitmapImage(), 14.99, "Vegetarian", "restaurant_7", 18),
            new Food("Salad Bowl at Veggie Haven", "Lettuce, Cucumber, Bell Peppers", new BitmapImage(), 10.99, "Healthy", "restaurant_7", 20)
        },
        new List<Order>(),
    ...
    new Restaurant("restaurant_8", "password123", "Seafood Paradise", "Boston", "505 Birch St", false, true, 4.6,
        new List<Food>
        {
            new Food("Lobster Roll at Seafood Paradise", "Lobster Meat, Buttered Roll", new BitmapImage(), 28.50, "Seafood", "restaurant_8", 15),
            new Food("Fish and Chips at Seafood Paradise", "Fried Fish, Potato Wedges",new BitmapImage(), 19.75, "Seafood", "restaurant_8", 12)
        },
        new List<Order>(),
